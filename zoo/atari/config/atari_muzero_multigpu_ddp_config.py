...
atari_muzero_config = dict(
    exp_name=f'data_mz_ctree/resnet_double/{env_id[:-14]}_muzero_ns{num_simulations}_upc{update_per_collect}_rr{reanalyze_ratio}_ddp_{gpu_num}gpu_seed0',
    env=dict(
        stop_value=int(1e6),
        env_id=env_id,
        obs_shape=(4, 96, 96),
...
if __name__ == "__main__":
    ...
    Overview:
        ...
        python -m torch.distributed.run --nproc_per_node=2 ./LightZero/zoo/atari/config/atari_muzero_multigpu_ddp_config.py
    """
